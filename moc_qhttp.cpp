...
QT_MOC_LITERAL(1, 6, 7), // "present"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 1), // "d"
QT_MOC_LITERAL(4, 17, 1), // "f"
QT_MOC_LITERAL(5, 19, 4), // "over"
QT_MOC_LITERAL(6, 24, 4), // "code"
QT_MOC_LITERAL(7, 29, 5), // "error"
QT_MOC_LITERAL(8, 35, 27), // "QNetworkReply::NetworkError"
QT_MOC_LITERAL(9, 63, 2), // "er"
QT_MOC_LITERAL(10, 66, 5), // "Error"
QT_MOC_LITERAL(11, 72, 6), // "Datain"
QT_MOC_LITERAL(12, 79, 8) // "Dataover"

    },
    "QHTTP\0present\0\0d\0f\0over\0code\0error\0"
    "QNetworkReply::NetworkError\0er\0Error\0"
    "Datain\0Dataover"
};
...
static const uint qt_meta_data_QHTTP[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::QByteArray, QMetaType::Int,    3,    6,
...
void QHTTP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->present((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 1: _t->over((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        case 4: _t->Datain(); break;
        case 5: _t->Dataover(); break;
        default: ;
        }
        ...
        {
            typedef void (QHTTP::*_t)(QByteArray , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHTTP::present)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QHTTP::*_t)(QByteArray , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHTTP::over)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QHTTP::*_t)(QNetworkReply::NetworkError );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHTTP::error)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void QHTTP::present(QByteArray _t1, bool _t2)
{
...
// SIGNAL 1
void QHTTP::over(QByteArray _t1, int _t2)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 2
void QHTTP::error(QNetworkReply::NetworkError _t1)
{
